...
2. Create a regression test in scripts/smoke-src/
...
2. Implement the fix
3. Create regression test in scripts/smoke-src/
4. Log to failure-registry.jsonl using scripts/log_failure.py
5. Run regression check before committing
6. Include "Co-Authored-By: Claude <noreply@anthropic.com>" in commit message
```
